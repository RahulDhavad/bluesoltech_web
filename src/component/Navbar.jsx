...
const Navbar = () => {
    ...
    return (
        <div>
            ...
            {isPopupOpen && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-75 h-full flex items-center justify-center z-50">
                    {/* Your popup content goes here */}
                    <div className=" bg-white">
                        <div className="justify-end text-right m-3">
                            <button className="bg-black text-white m-2 rounded-lg" onClick={handleButtonClick}><IoIosCloseCircle className="w-6 h-6" /></button>
                        </div>
                            ...
                            <section class="mb-10">
                                <div className="flex justify-center">
                                    <div className="text-center md:max-w-xl lg:max-w-3xl">
                                        <h2 className="mb-4 px-6 text-3xl font-bold"><u>Contact us</u></h2>
                                    </div>
                                </div>

                                <div className="flex flex-wrap ">
                                    <div className="w-full md:w-1/2 lg:w-5/12 md:px-3 lg:mb-0 lg:px-6">
                                        <form>
                                            <div class="">
                                                <div>
                                    ...
                                    <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12 mt-8">
                                        <div class="flex flex-wrap">
                                            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                                                <div class="flex items-start">
                                                    <div class="shrink-0">
                                                        <div class="inline-block rounded-md bg-blue-100 p-4 text-primary">
                                            ...
                                            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                                                <div class="flex items-start">
                                                    <div class="shrink-0">
                                                        <div class="inline-block rounded-md bg-blue-100 p-4 p-4 text-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                                                stroke="currentColor" class="h-6 w-6">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                                                <div class="align-start flex">
                                                    ...
                                                    <div class="ml-6 grow">
                                                        <p class="mb-2 font-bold dark:text-white">Our Services</p>
                                                        <p class="text-neutral-500 dark:text-neutral-200">
                                                            24 ✘  7
                                                        </p>
                                            ...
                                            <div className="flex items-center justify-center">
                                                <div className="w-full md:w-6/12 md:px-3 lg:px-6 text-center">
                                                    <img src={img6} className="w-full" alt="no img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
