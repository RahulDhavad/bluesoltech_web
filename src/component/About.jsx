...
const About = (index) => {
  ...
  return (
    <div id='about_page'>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 p-4">
            ...
            >
              ...
              <p className="mb-4 text-gray-600">
                With a team of highly skilled engineers adept in the latest software standards, we leverage our extensive
                knowledge to provide tailored solutions that meet client needs, expectations, and budgets. By prioritizing
                client satisfaction, we are proud to maintain support for our first business client. Our commitment to
                excellence and attention to detail ensures we exceed expectations, while our adaptability and expertise
                drive success for both new and longstanding clients.
              </p>
      ...
      <div className="border w-[1220px] mx-auto mt-4 shadow-lg p-6 mb-6 bg-white rounded-md" >
        {/* Tabs */}
        <ul className="inline-flex pt-2 px-1 w-full border-b">
          <li className={`px-4 font-semibold py-2 rounded-t  ${activeTab === 'first' ? 'bg-slate-100 border-t border-r border-l -mb-px' : ''}`}>
            <div onClick={() => handleTabClick('first')} className="cursor-pointer">
              Our Mission
            </div>
          </li>
          <li className={`px-4 font-semibold py-2 rounded-t  ${activeTab === 'second' ? 'bg-slate-100 border-t border-r border-l -mb-px' : ''}`}>
            <div onClick={() => handleTabClick('second')} className="cursor-pointer">
              Our Vision
            </div>
          </li>
          <li className={`px-4 font-semibold py-2 rounded-t  ${activeTab === 'third' ? 'bg-slate-100 border-t border-r border-l -mb-px' : ''}`}>
            <div onClick={() => handleTabClick('third')} className="cursor-pointer">
            Our History
            </div>
          </li>
          <li className={`px-4 font-semibold py-2 rounded-t  ${activeTab === 'fourth' ? 'bg-slate-100 border-t border-r border-l -mb-px' : ''}`}>
            <div onClick={() => handleTabClick('fourth')} className="cursor-pointer">
            Our Goal
            </div>
          </li>
        </ul>
        ...
        <div id="tab-contents ">
          <div id="first" className={`p-4 ${activeTab === 'first' ? '' : 'hidden'}`}>
            <div className='flex flex-col pt-6 sm:flex-row bg-slate-100'>
              <motion.div
                className="card"
                initial={{
                  opacity: 0,
              ...
              >
                ...
                <div className='w-full sm:w-[550px] p-4 sm:p-10'>
                  <h1 className='text-2xl sm:text-4xl font-bold mb-4 text-gray-600'>
                    Our Mission
                  </h1>
          ...
          <div id="second" className={`p-4 ${activeTab === 'second' ? '' : 'hidden'}`}>
            <div className='flex flex-col mt-6 sm:flex-row bg-slate-100'>
              <motion.div
                className="card"
                initial={{
                  opacity: 0,
              ...
              >
                ...
                <div className='w-full sm:w-[550px] p-4 sm:p-10'>
                  ...
                  <p className='text-gray-700'>
                    Pioneering Technological Frontiers</p>
                  <p className='text-gray-700'>
            ...
            <div className='flex flex-col mt-6 sm:flex-row bg-slate-100'>
              ...
              >
                ...
                <div className='w-full sm:w-[550px] p-4 sm:p-10'>
                  ...
                  <p className='text-gray-700'>
                    Building Tomorrow: The Legacy of Blue Soltech</p>
                  <p className='text-gray-700'>
                    We see ourselves at the forefront of technological
                    advancements, leading the charge in developing solutions that
                    not only meet the needs of today but anticipate the challenges
            ...
            <div className='flex flex-col mt-6 sm:flex-row bg-slate-100'>
              ...
              >
                ...
                <div className='w-full sm:w-[550px] p-4 sm:p-10'>
                  ...
                  <p className='text-gray-700'>
                    Empowering Progress: Unveiling Our Strategic Goals as a Leader</p>
                  <p className='text-gray-700'>
